...
if (USE_MOCK) {
  ...
  const MOCK_PREDICTIONS = [
    ...
    { event_id: "EVT-2003", prediction: "Suspicious", threat_type: "Malware", confidence_score: 87.5, anomaly_score: 0.781, severity: "High", model_version: "IF_v1", prediction_timestamp: "2026-08-22T08:30:00Z" },
    { event_id: "EVT-2004", prediction: "Normal", threat_type: "None", confidence_score: 95.4, anomaly_score: 0.012, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-22T08:12:45Z" },
    { event_id: "EVT-2005", prediction: "Suspicious", threat_type: "DDoS Attack", confidence_score: 91.8, anomaly_score: 0.835, severity: "High", model_version: "IF_v1", prediction_timestamp: "2026-08-22T07:55:20Z" },
    { event_id: "EVT-2006", prediction: "Suspicious", threat_type: "SQL Injection", confidence_score: 88.9, anomaly_score: 0.796, severity: "High", model_version: "IF_v1", prediction_timestamp: "2026-08-22T06:40:10Z" },
    { event_id: "EVT-2007", prediction: "Normal", threat_type: "None", confidence_score: 98.7, anomaly_score: -0.098, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-22T05:30:15Z" },
    { event_id: "EVT-2008", prediction: "Suspicious", threat_type: "Data Exfiltration", confidence_score: 93.6, anomaly_score: 0.867, severity: "Critical", model_version: "IF_v1", prediction_timestamp: "2026-08-22T04:15:00Z" },
    { event_id: "EVT-2009", prediction: "Normal", threat_type: "None", confidence_score: 92.1, anomaly_score: 0.054, severity: "Medium", model_version: "IF_v1", prediction_timestamp: "2026-08-22T03:50:22Z" },
    { event_id: "EVT-2010", prediction: "Suspicious", threat_type: "Unauthorized Access", confidence_score: 84.2, anomaly_score: 0.724, severity: "Medium", model_version: "IF_v1", prediction_timestamp: "2026-08-22T03:10:05Z" },
    { event_id: "EVT-2011", prediction: "Normal", threat_type: "None", confidence_score: 97.5, anomaly_score: -0.045, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-22T02:45:00Z" },
    { event_id: "EVT-2012", prediction: "Suspicious", threat_type: "Brute Force", confidence_score: 79.8, anomaly_score: 0.685, severity: "Medium", model_version: "IF_v1", prediction_timestamp: "2026-08-22T01:30:18Z" },
    { event_id: "EVT-2013", prediction: "Normal", threat_type: "None", confidence_score: 94.6, anomaly_score: 0.021, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-22T00:55:00Z" },
    { event_id: "EVT-2014", prediction: "Suspicious", threat_type: "Phishing", confidence_score: 86.3, anomaly_score: 0.758, severity: "Medium", model_version: "IF_v1", prediction_timestamp: "2026-08-21T23:40:12Z" },
    { event_id: "EVT-2015", prediction: "Normal", threat_type: "None", confidence_score: 96.9, anomaly_score: -0.088, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-21T22:15:30Z" },
    { event_id: "EVT-2016", prediction: "Suspicious", threat_type: "Reconnaissance", confidence_score: 72.1, anomaly_score: 0.612, severity: "Low", model_version: "IF_v1", prediction_timestamp: "2026-08-21T21:05:00Z" },
  ...
  return apiClient.get('/api/v1/incidents', { params })
    .then((res) => {
      ...
      if (filters.riskLevel && filters.riskLevel !== 'All') {
        incidents = incidents.filter((incident) => incident.risk_level === filters.riskLevel)
      }
      return {
        threats: incidents.map((incident) => ({
